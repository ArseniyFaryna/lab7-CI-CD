# Lab6_faryna_gold_layer

This folder defines all source code for the 'Lab6_faryna_gold_layer' pipeline:
...
* Take a look at the sample under "sample_users_lab6_faryna_gold_layer.py" to get familiar with the syntax.
